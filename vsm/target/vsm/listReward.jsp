    ...
    <div class="mainContent">
        ...
        <table cellpadding="0" cellspacing="0" class="list_hy">
            <tr>
                <th scope="col">打赏人</th>
                <th scope="col">接受人</th>
                <th scope="col">所属视频</th>
                <th scope="col">金额</th>
                <th scope="col">备注</th>
            </tr>
            <c:forEach items="${rewardRecords}" var="rewardRecord">
                <tr>
                    <td>${rewardRecord.userId}</td>
                    <td>${rewardRecord.rewardId}</td>
                    <td>${rewardRecord.videoId}</td>
                    <td>${rewardRecord.rewardNum}</td>
                    <td>${rewardRecord.remark}</td>
                </tr>
            </c:forEach>
        </table>
    </div>
