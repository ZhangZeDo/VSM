...
<div class="main">
    ...
    <div class="mainContent">
        <div class="box_t">
            <span class="name">添加视频类型</span>
        </div>
        <div class="space_hx">&nbsp;</div>
        <form action="/addVideoType" method="post" name="addVideoTypeForm">
            <div class="xjhy">
                <!--高级配置-->
                <ul class="hypz gjpz clearfix">
                    <li class="clearfix">
                        <span class="title">视频类型名称：</span>
                        <div class="li_r">
                            <input class="chang" name="videoTypeName" type="text"/>
                            <i>*</i>
                        </div>
                    </li>

                    <li class="clearfix">
                        <p style="font-size: 10px ; color: #c71012">${addVideoTypeMsg}</p>
                    </li>

                    <li class="tj_btn">
                        <a href="javascript:history.go(-1);" class="back">返回</a>
                        <a href="javascript:addVideoTypeForm.submit();">保存</a>
                    </li>
                </ul>
                <!--高级配置-->
            </div>
